...
FPlayerSaveData* USSaveGame::GetPlayerData(APlayerState* PlayerState)
{
	...
	//UObject dont have access to UWorld, so we grab it via PlayerState instead
	...
	//Easiest way to deal with the different IDs is as FString (original Steam id is unit64)
