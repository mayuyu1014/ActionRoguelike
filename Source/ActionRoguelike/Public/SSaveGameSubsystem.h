...
protected:
	//Name of slot save/load to disk. Filled by SaveGameSettings (can be overriden from GameMode's InitGame())
...
public:
	...
	//Initialize subsystem, good moment to load in SaveGameSetting variables
